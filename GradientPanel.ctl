...
Attribute MouseUp.VB_Description = "Event fired when the user releases a mouse button while over the control."
...
Attribute MouseMove.VB_Description = "Event fired when the mouse moves over the control."
...
Private Sub UserControl_InitProperties()
    ...
    'Set the default size (will be over-ridden if sized by user to begin with)
    Height = 510
    Width = 1230
...
Private Sub UserControl_MouseDown(Button As Integer, _
                                ...
                                X As Single, _
                                Y As Single)
    RaiseEvent MouseDown(Button, Shift, ScaleX(X, ScaleMode, UserControl.Parent.ScaleMode), ScaleY(Y, ScaleMode, UserControl.Parent.ScaleMode))     'Pass the event along to the developer (Although rescale the X and Y co-ordinates)
End Sub
...
Private Sub UserControl_MouseMove(Button As Integer, _
                                ...
                                X As Single, _
                                Y As Single)
    RaiseEvent MouseMove(Button, Shift, ScaleX(X, ScaleMode, UserControl.Parent.ScaleMode), ScaleY(Y, ScaleMode, UserControl.Parent.ScaleMode))     'Pass the event along to the developer (Although rescale the X and Y co-ordinates)
End Sub
...
Private Sub DrawCaption(ByVal Caption As String, _
    ...
    Select Case Alignment           'Select the alignment to be used
        Case gpaLeftTop             'Top Left Corner
            rct.Top = 1             'At Top vertically (Everything needs to be off one pixel in case caption styles are used)
            rct.Left = 1            'Left side
        ...
        Case gpaLeftBottom          'Bottom Left Corner
            rct.Top = CLng((ScaleY(ScaleHeight, ScaleMode, vbPixels) - Height) - 2)     'At Bottom vertically
            rct.Left = 1            'Left side
            'Fill out rest of rect from width and height
            rct.Bottom = rct.Top + Height
            rct.Right = rct.Left + Width
        Case gpaRightTop            'Top Right Corner
            rct.Top = 1             'At Top vertically
            rct.Left = CLng((ScaleX(ScaleWidth, ScaleMode, vbPixels) - Width) - 2)      'Right side
            'Fill out rest of rect from width and height
            rct.Bottom = rct.Top + Height
            rct.Right = rct.Left + Width
